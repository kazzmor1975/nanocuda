    ...
    pl: [
        {
            ...
            dimensions: [
                { id: "sensitivity", label: "Wysoka czułość", opposite: "Szeroki zakres" },
                { id: "stability", label: "Długotrwała stabilność", opposite: "Szybki czas reakcji" },
                { id: "cost", label: "Niski koszt / Skalowalność", opposite: "Zaawansowane właściwości" }
            ],
            materials: [
                {
                    id: "sensor_graphene",
                    ...
                    strengths: ["Ekstremalna czułość", "Szybki czas reakcji", "Wysokie przewodnictwo elektryczne"],
                    limitations: ["Podatność na dryft linii bazowej", "Trudność w osiągnięciu wysokiej selektywności bez złożonej funkcjonalizacji"],
                    ratings: { sensitivity: 5, stability: 2, cost: 3 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Wysoka stabilność", "Niski koszt", "Dobrze poznane mechanizmy wykrywania gazów"],
                    limitations: ["Często wymaga wysokich temperatur pracy (200-400°C)"],
                    ratings: { sensitivity: 4, stability: 5, cost: 5 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Doskonała elastyczność mechaniczna", "Dobra praca w temperaturze pokojowej"],
                    limitations: ["Trudność w jednorodnym dyspergowaniu w kompozytach", "Zmienność właściwości między partiami"],
                    ratings: { sensitivity: 4, stability: 3, cost: 3 },
                    experimentalPath: [
            ...
            targetProperties: ["Przewodnictwo", "Powierzchnia właściwa", "Selektywność", "Stabilność"],
            methods: [
                { name: "Spektroskopia Ramana", why: "Identyfikuje defekty i liczbę warstw w materiałach węglowych." },
                { name: "SEM/AFM", why: "Wizualizuje morfologię powierzchni i grubość warstwy czujnika." },
                { name: "EIS", why: "Mierzy zmiany oporu elektrycznego / pojemności." },
                { name: "XRD", why: "Potwierdza strukturę krystaliczną tlenków metali." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "biocompatibility", label: "Bioaktywność / Integracja", opposite: "Obojętność (Inertność)" },
                { id: "strength", label: "Wytrzymałość mechaniczna", opposite: "Wysoka porowatość" },
                { id: "ease", label: "Łatwość syntezy", opposite: "Złożona funkcjonalizacja" }
            ],
            materials: [
                {
                    id: "bio_ha",
                    ...
                    strengths: ["Doskonała osteokonduktywność", "Wspomaga wrastanie tkanki kostnej"],
                    limitations: ["Kruchość", "Słabe właściwości nośne samodzielnie"],
                    ratings: { biocompatibility: 5, strength: 2, ease: 4 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Szybka reakcja powierzchniowa in vivo", "Może stymulować ekspresję genów do naprawy kości"],
                    limitations: ["Trudność w formowaniu w złożone kształty bez utraty bioaktywności"],
                    ratings: { biocompatibility: 5, strength: 3, ease: 3 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Wysoce kontrolowane tempo degradacji", "Elastyczność i sprężystość"],
                    limitations: ["Możliwa reakcja zapalna na produkty uboczne degradacji"],
                    ratings: { biocompatibility: 3, strength: 4, ease: 5 },
                    experimentalPath: [
            ...
            targetProperties: ["Biokompatybilność", "Porowatość", "Wytrzymałość mechaniczna", "Chemia powierzchni"],
            methods: [
                { name: "FTIR", why: "Identyfikuje grupy funkcyjne i potwierdza modyfikacje powierzchni." },
                { name: "SEM", why: "Obserwuje wielkość porów i morfologię przylegania komórek." },
                { name: "Kąt zwilżania", why: "Określa hydrofilowość, kluczową dla adsorpcji białek." },
                { name: "Testy in vitro (np. MTT)", why: "Testuje żywotność komórek i cytotoksyczność." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "hardness", label: "Twardość i ścieralność", opposite: "Elastyczność" },
                { id: "protection", label: "Ochrona przed korozją", opposite: "Przejrzystość optyczna" },
                { id: "cost", label: "Niski koszt aplikacji", opposite: "Procesy próżniowe" }
            ],
            materials: [
                {
                    id: "coat_oxide",
                    ...
                    strengths: ["Doskonałe właściwości optyczne", "Zdolności samoczyszczące (TiO2)"],
                    limitations: ["Podatność na pękanie pod naprężeniem mechanicznym", "Wymaga promieniowania UV do fotokatalizy"],
                    ratings: { hardness: 3, protection: 4, cost: 4 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Ekstremalna twardość", "Wysoka stabilność termiczna"],
                    limitations: ["Drogie metody osadzania (PVD/CVD)", "Słaba adhezja przy niedopasowaniu cieplnym"],
                    ratings: { hardness: 5, protection: 5, cost: 1 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Bardzo elastyczne", "Łatwe do nałożenia na duże/złożone obszary"],
                    limitations: ["Niższa stabilność termiczna", "Podatne na degradację UV w czasie"],
                    ratings: { hardness: 2, protection: 4, cost: 5 },
                    experimentalPath: [
            ...
            targetProperties: ["Adhezja", "Twardość", "Chropowatość", "Odporność na korozję", "Przezroczystość"],
            methods: [
                { name: "AFM / Profilometria", why: "Mierzy chropowatość w skali nano i grubość powłoki." },
                { name: "Nanownikanie", why: "Określa twardość i moduł sprężystości cienkich warstw." },
                { name: "Testy elektrochemiczne (Tafel)", why: "Oceniają odporność na korozję w określonych środowiskach." },
                { name: "TEM/SEM przekroju", why: "Bada interfejs między powłoką a podłożem." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "capacity", label: "Wysoka pojemność właściwa", opposite: "Wysoka moc / Cyklowalność" },
                { id: "stability", label: "Stabilność cykliczna", opposite: "Pojemność początkowa" },
                { id: "cost", label: "Niski koszt / Powszechne", opposite: "Rzadkie / Drogie pierwiastki" }
            ],
            materials: [
                {
                    id: "ec_carbon",
                    ...
                    strengths: ["Doskonała stabilność cykliczna", "Wysoka gęstość mocy"],
                    limitations: ["Niska gęstość energii w porównaniu z tlenkami metali"],
                    ratings: { capacity: 2, stability: 5, cost: 4 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Wysoka pojemność właściwa / gęstość energii", "Dostępne liczne stany redoks"],
                    limitations: ["Słabe samoistne przewodnictwo elektryczne", "Rozszerzanie objętości podczas cyklowania"],
                    ratings: { capacity: 5, stability: 2, cost: 3 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Elastyczność mechaniczna", "Wysokie przewodnictwo", "Szybka kinetyka domieszkowania"],
                    limitations: ["Słaba długoterminowa stabilność z powodu degradacji strukturalnej"],
                    ratings: { capacity: 3, stability: 1, cost: 5 },
                    experimentalPath: [
            ...
            targetProperties: ["Przewodnictwo elektryczne", "Szybkość transportu jonów", "Stabilność cykliczna", "Aktywna powierzchnia elektrochemiczna"],
            methods: [
                { name: "Woltamperometria cykliczna (CV)", why: "Identyfikuje piki redoks i zachowanie elektrochemiczne." },
                { name: "Galwanostatyczne ładowanie/rozładowanie", why: "Mierzy pojemność właściwą i żywotność cykliczną." },
                { name: "Analiza powierzchni BET", why: "Określa ilościowo dostępną powierzchnię do adsorpcji jonów." },
                { name: "EIS", why: "Oddziela rezystancję przeniesienia ładunku od ograniczeń dyfuzji." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "activity", label: "Wysoka aktywność", opposite: "Selektywność" },
                { id: "stability", label: "Odporność na zatrucie", opposite: "Początkowa rotacja" },
                { id: "cost", label: "Powszechne na Ziemi", opposite: "Metale szlachetne" }
            ],
            materials: [
                {
                    id: "cat_precious",
                    ...
                    strengths: ["Wyjątkowa aktywność katalityczna w niskich temperaturach", "Dobrze zdefiniowane mechanizmy reakcji"],
                    limitations: ["Bardzo wysoki koszt", "Podatność na zatrucie CO"],
                    ratings: { activity: 5, stability: 3, cost: 1 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Doskonała selektywność kształtu", "Wysoka stabilność termiczna", "Niski koszt"],
                    limitations: ["Ograniczenia transportu masy w mikroporach", "Mniej aktywne w niektórych reakcjach redoks"],
                    ratings: { activity: 3, stability: 4, cost: 5 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Mogą wykorzystywać energię słoneczną", "Chemicznie stabilne w środowiskach wodnych"],
                    limitations: ["Wymagają światła UV ze względu na szeroką przerwę energetyczną", "Szybka rekombinacja ładunków"],
                    ratings: { activity: 4, stability: 5, cost: 4 },
                    experimentalPath: [
            ...
            targetProperties: ["Aktywność katalityczna", "Selektywność", "Odporność na zatrucie", "Powierzchnia", "Przerwa energetyczna (fotokatalizatory)"],
            methods: [
                { name: "BET / Chemisorpcja", why: "Mierzy całkowitą powierzchnię właściwą i dyspersję metalu." },
                { name: "XRD", why: "Określa wielkość krystalitów i czystość fazową." },
                { name: "TEM", why: "Wizualizuje rozkład wielkości i kształtów nanocząstek." },
                { name: "Spektroskopia UV-Vis", why: "Oblicza optyczną przerwę energetyczną dla fotokatalizatorów." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "selectivity", label: "Wysoka selektywność/odrzucenie", opposite: "Wysoka przepuszczalność" },
                { id: "fouling", label: "Właściwości antyfoulingowe", opposite: "Podstawowa filtracja" },
                { id: "robustness", label: "Wytrzymałość mechaniczna", opposite: "Warstwy ultracienkie" }
            ],
            materials: [
                {
                    id: "filt_go",
                    ...
                    strengths: ["Grubość w skali atomowej", "Dostrajalne odstępy międzywarstwowe"],
                    limitations: ["Pęcznienie w środowisku wodnym", "Trudność w bezdefektowym skalowaniu"],
                    ratings: { selectivity: 4, fouling: 3, robustness: 2 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Bardzo wysoka porowatość i przepuszczalność", "Łatwe do funkcjonalizacji"],
                    limitations: ["Zbyt duże pory dla odwróconej osmozy", "Delikatność mechaniczna"],
                    ratings: { selectivity: 2, fouling: 4, robustness: 3 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Wyjątkowa zdolność sita molekularnego", "Wysoce uporządkowane krystaliczne pory"],
                    limitations: ["Słaba stabilność hydrotermalna w niektórych MOF", "Kruchość komplikuje produkcję"],
                    ratings: { selectivity: 5, fouling: 2, robustness: 1 },
                    experimentalPath: [
            ...
            targetProperties: ["Przepuszczalność", "Wskaźnik selektywności/odrzucenia", "Wytrzymałość mechaniczna", "Odporność na zanieczyszczenia (fouling)"],
            methods: [
                { name: "Filtracja dead-end / cross-flow", why: "Mierzy strumień wody i skuteczność odrzucania." },
                { name: "Kąt zwilżania", why: "Ocenia hydrofilowość." },
                { name: "SEM", why: "Bada przekrój membrany i strukturę porów." },
                { name: "Potencjał Zeta", why: "Mierzy ładunek powierzchniowy." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "strength", label: "Wytrzymałość / Moduł", opposite: "Ciągliwość" },
                { id: "thermal", label: "Stabilność termiczna", opposite: "Przetwarzanie w niskich temp." },
                { id: "dispersion", label: "Łatwość dyspergowania", opposite: "Ekstremalna wydajność" }
            ],
            materials: [
                {
                    id: "struc_cnt",
                    ...
                    strengths: ["Niezrównany stosunek wytrzymałości do wagi", "Mogą nadać polimerom przewodnictwo"],
                    limitations: ["Ekstremalna trudność w uzyskaniu jednorodnej dyspersji", "Wysoki koszt"],
                    ratings: { strength: 5, thermal: 4, dispersion: 1 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Niski koszt", "Doskonałe właściwości barierowe i zmniejszające palność"],
                    limitations: ["Skromna poprawa wytrzymałości absolutnej", "Wymaga precyzyjnej modyfikacji organicznej"],
                    ratings: { strength: 3, thermal: 3, dispersion: 4 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Wydajność w wysokich temperaturach", "Doskonała odporność na zużycie"],
                    limitations: ["Złożona produkcja (metalurgia proszków)", "Obróbka skrawaniem jest bardzo trudna"],
                    ratings: { strength: 4, thermal: 5, dispersion: 2 },
                    experimentalPath: [
            ...
            targetProperties: ["Wytrzymałość na rozciąganie", "Moduł sprężystości", "Odporność na pękanie", "Stabilność termiczna"],
            methods: [
                { name: "Testy rozciągania / zginania", why: "Mierzą makroskopowe właściwości mechaniczne." },
                { name: "Analiza DMA", why: "Ocenia właściwości lepkosprężyste (Tg)." },
                { name: "TEM / SEM przełomów", why: "Bada dyspersję nanowypełniaczy i mechanizmy niszczenia." },
                { name: "TGA", why: "Określa temperaturę degradacji termicznej." }
            ],
        ...
        },
        {
            ...
            dimensions: [
                { id: "efficiency", label: "Wydajność kwantowa", opposite: "Szerokie widmo" },
                { id: "safety", label: "Niska toksyczność", opposite: "Na bazie metali ciężkich" },
                { id: "stability", label: "Fotostabilność", opposite: "Łatwo degradowalne" }
            ],
            materials: [
                {
                    id: "opt_qd",
                    ...
                    strengths: ["Niezwykle wysoka wydajność kwantowa", "Dostrajalne kolory emisji", "Wąskie piki emisji"],
                    limitations: ["Kwestie toksyczności (Cd, Pb)", "Podatne na fotowybielanie bez struktur rdzeń-powłoka"],
                    ratings: { efficiency: 5, safety: 1, stability: 3 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Ogromne przekroje poprzeczne rozpraszania", "Wysoce biokompatybilne (Au)"],
                    limitations: ["Wysoki koszt metali szlachetnych", "Szeroka emisja w porównaniu z QD"],
                    ratings: { efficiency: 4, safety: 5, stability: 5 },
                    experimentalPath: [
                ...
                },
                {
                    ...
                    strengths: ["Zerowa autofluorescencja tła w tkance biologicznej", "Głęboka penetracja tkanek (światło NIR)"],
                    limitations: ["Bardzo niska ogólna wydajność kwantowa", "Złożona synteza wymagająca metali ziem rzadkich"],
                    ratings: { efficiency: 1, safety: 4, stability: 5 },
                    experimentalPath: [
            ...
            targetProperties: ["Wydajność kwantowa PL (PLQY)", "Długość fali emisji/absorpcji", "Fotostabilność", "Współczynnik załamania"],
            methods: [
                { name: "Spektroskopia fotoluminescencji (PL)", why: "Mierzy widma emisji i identyfikuje stany defektów." },
                { name: "Spektroskopia UV-Vis", why: "Identyfikuje piki absorpcji i pasma LSPR." },
                { name: "DLS", why: "Określa rozmiar hydrodynamiczny i stabilność koloidalną w zawiesinie." }
            ],
